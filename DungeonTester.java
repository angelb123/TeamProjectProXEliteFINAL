...
public class DungeonTester {
	...
	public static DungeonCharacter chooseDungeonCharacter()
	{
		...
		if(choice == 1)
		{
			...
			return heroFactory.createThief(name);
		}
		...
		else if (choice == 3)
		{
			System.out.println("Enter a name for your hero: ");
			String name = input.next();
			return heroFactory.createWarrior(name);
		}
	...
	public static void battle(DungeonCharacter theHero, DungeonCharacter theMonster)
	{
		...
		
		{
		    ...
		    while(turns > 0)
		    {
		    	...
		    	System.out.println("Option 2: " + theHero.getSpecialMove());
		    	...
		    	{
		    		theHero.doSpecialMove(theMonster);
		    	}
